 ...
 * La clase se creó el 16/02/2023 por Adaya Elías Gracia.
 * Esta es la versión 2.4
 */
//Modificar.
public class EntradaBlogAEG {
...
//es negativo, lanza una excepción.
    public EntradaBlogAEG(int id,String autor,String texto)throws IllegalArgumentException{
...
//No tiene porqué tener argumentos.
    public static void main(String[] args) {
        //Modificar.
        EntradaBlogAEG e1=new EntradaBlogAEG (3,"Adaya","Últimas noticias, está disponible BixBy 2.0");
